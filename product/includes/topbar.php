    ...
    <!-- Content Wrapper -->
    <div id="content-wrapper" class="d-flex flex-column" style="background-color: #95F985">
           ...
           <li  class="nav-item" ><img src="../img/Logo.png" style="width: 200%;height: 35px;float: right;margin-top: 30%"></li>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 big"><b>Welcome <br/><?php echo  $_SESSION['FIRST_NAME'] ;?></b></span>
