            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-success  text-uppercase mb-1">Last week income</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
                      <?php 
                          $today = date('Y-m-d');
             ...
             <div class="col-md-12 mb-3">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Today-Sells</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
                        <?php 
                     $today = date('Y-m-d');
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Last-week-Repair</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800">
                          <?php 
            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Last Week Expense</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
                      <?php 
                            $today = date('Y-m-d');
                            $query = "SELECT SUM(bank_ex) AS bank_ex, SUM(salary) AS salary, SUM(product_pursh) AS product_pursh, 
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Today Balance</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800">
...
<div class="col-md-12 mb-3">
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Last-week-sells</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h6 mb-0 mr-3 font-weight-bold text-gray-800">
                          <?php 
            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Last week Balance</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
          ...
          <!-- RECENT PRODUCTS -->
              ...
              <div class="panel-body">
                  ...
                  <strong>Sells Product</strong>
                    <?php 
                    date_default_timezone_set("Asia/Dhaka");
                    date_default_timezone_get();
                    $date = date('Y-m-d');
                      $query = "SELECT * FROM `transaction` INNER JOIN product ON transaction.product_id = product.PRODUCT_ID WHERE DATE ='$date' ORDER BY `transaction`.`TRANS_ID` DESC LIMIT 5";
                      $result = mysqli_query($db, $query);
                      if(mysqli_num_rows($result)>0){
                        while ($row = mysqli_fetch_array($result)) { 
                          $total = $row['addv'] + $row['payment'];
                          echo $row['NAME'] ." : ".$total ." TK. <br>";
                          }
                      }else{
                      ...
                      <strong>Repair Product</strong>
                    <?php 
                      $query = "SELECT * FROM `reapair_product_tabel`  WHERE repair_satr_date ='$date'  ORDER BY `reapair_product_tabel`.`repaire_id` DESC  LIMIT 5";
                      $result = mysqli_query($db, $query);
                      if(mysqli_num_rows($result)>0){
                        while ($row = mysqli_fetch_array($result)) { 
                          $total = $row['product_adavnce'] + $row['payment_price'];
                          echo $row['product_name'] ." : ".$total ." TK. <br>";
                        ...
                        ?>
                      <p class="p-0 my-2" style="border-bottom:1px solid;"> </p>
                      <strong>Office Expence</strong>
                      <?php 
                      $query = "SELECT * FROM `total_daily_ex` WHERE repair_satr_date ='$date'  ORDER BY `total_daily_ex`.`id` DESC   LIMIT 5";
                      $result = mysqli_query($db, $query);
                      if(mysqli_num_rows($result)>0){
                        while ($row = mysqli_fetch_array($result)) { 
                          $total = $row['product_adavnce'] + $row['payment_price'];
