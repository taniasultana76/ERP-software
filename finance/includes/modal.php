      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="">
            ...
            <div class="form-group">
              <input class="form-control" placeholder="Address" name="adds" required>
            </div>
            ...
            <hr>
            <button type="submit" name="submit1" class="btn btn-success"><i class="fa fa-check fa-fw"></i>Save</button>
...
if(isset($_POST['submit1']))
{
  ...
  $query1 = "INSERT INTO customer
                    (CUST_ID, FIRST_NAME, address, PHONE_NUMBER)
                    VALUES (Null,'{$fname}','{$add}','{$pn}')";
